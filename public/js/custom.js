...
var addBagBtn = _toConsumableArray(document.querySelectorAll('.bag-btn'));

addBagBtn.forEach(function (button) {
  button.addEventListener('click', function () {
    var bId = button.id; // let InCart=Cart.find(item =>item.id == bId);

    count++;
    var basketCount = document.getElementById('basketCount').innerText = count;
    var btnCount = document.getElementById('countValue');
